...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 1:
      ...
      if (lookahead == 'x') ADVANCE(508);
      if (lookahead == 0x85 ||
          lookahead == 0x2028) ADVANCE(507);
      if (set_contains(sym_escape_sequence_character_set_2, 11, lookahead)) ADVANCE(505);
    ...
    case 176:
      if (lookahead == '|') ADVANCE(118);
      if ((!eof && set_contains(aux_sym_directive_token1_character_set_2, 17, lookahead))) ADVANCE(604);
      END_STATE();
    case 177:
      if (lookahead == '+' ||
    ...
    case 302:
      ACCEPT_TOKEN(aux_sym_directive_token1);
      if ((!eof && set_contains(aux_sym_directive_token1_character_set_2, 17, lookahead))) ADVANCE(302);
      END_STATE();
    case 303:
    ...
    case 312:
      ...
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(312);
      if ((!eof && set_contains(aux_sym_directive_token1_character_set_2, 17, lookahead))) ADVANCE(602);
      END_STATE();
    case 313:
      ACCEPT_TOKEN(sym_number);
    ...
    case 506:
      ACCEPT_TOKEN(sym_escape_sequence);
      if (lookahead == '\n' ||
          lookahead == 0x85) ADVANCE(507);
      if (set_contains(sym_escape_sequence_character_set_1, 9, lookahead)) ADVANCE(507);
      END_STATE();
    case 507:
      ACCEPT_TOKEN(sym_escape_sequence);
